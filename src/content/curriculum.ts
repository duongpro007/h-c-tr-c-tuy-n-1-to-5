...
const th1Topics: Topic[] = [
  ...
  topic("Nhận biết một số biểu tượng quen thuộc", "Nhận diện biểu tượng thường gặp trên màn hình."),
...
const th2Topics: Topic[] = [
  ...
  topic("Nhận biết máy tính để bàn và máy tính xách tay", "Phân biệt các loại máy tính thường gặp."),
...
const th3Topics: Topic[] = [
  ...
  topic("Sử dụng máy tính bảng, điện thoại thông minh cơ bản", "Làm quen thao tác cơ bản trên thiết bị di động."),
...
const th4Topics: Topic[] = [
  ...
  topic("Chèn bảng vào văn bản", "Thực hành tạo và chèn bảng vào văn bản."),
...
const th5Topics: Topic[] = [
  ...
  topic("Sử dụng phần mềm trình chiếu cơ bản", "Làm quen tạo một bài trình chiếu đơn giản."),
  topic("Làm quen bảng tính đơn giản", "Làm quen nhập liệu cơ bản trên bảng tính."),
